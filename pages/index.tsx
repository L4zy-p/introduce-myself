            ...
            <div className='portfolio-list'>
              <div className='portfolio-item'>
                <div className='image-box'>
                  <Image loader={myLoader} src='/port-elms.png' width={1898} height={903} />
                </div>
              ...
              <div className='portfolio-item'>
                <div className='image-box'>
                  <Image loader={myLoader} src='/port-queue.png' width={1898} height={903} />
                </div>
                <div className='description'>
              ...
              <div className='portfolio-item'>
                <div className='image-box'>
                  <Image loader={myLoader} src='/port-shimakaze.png' width={1898} height={903} />
                </div>
                <div className='description'>
                  <h2>Shimakaze</h2>
